...
# 貳、儀器與設備
st.header("貳、儀器與設備")
st.image("C:\\Users\\luxui\\thermal_fluid\\pages\\images\\a.png", caption=" ")
st.image("C:\\Users\\luxui\\thermal_fluid\\pages\\images\\b.png", caption=" ")
st.image("C:\\Users\\luxui\\thermal_fluid\\pages\\images\\c.png", caption=" ")
...
st.image("C:\\Users\\luxui\\thermal_fluid\\pages\\images\\d.png", caption=" ")
st.image("C:\\Users\\luxui\\thermal_fluid\\pages\\images\\e.png", caption=" ")
st.image("C:\\Users\\luxui\\thermal_fluid\\pages\\images\\f.png", caption=" ")
st.image("C:\\Users\\luxui\\thermal_fluid\\pages\\images\\g.png", caption=" ")
st.header("黏滯力之物理意義")
st.write("氣體:氣體之黏滯力是由氣體分子之間碰撞，造成動量交換而產生")
st.image("C:\\Users\\luxui\\thermal_fluid\\pages\\images\\h.png", caption=" ")
...
st.image("C:\\Users\\luxui\\thermal_fluid\\pages\\images\\i.png", caption=" ")
st.write("2. 取一個 600ml 標準燒杯，將樣品加至轉針測量高度，黏度計準備好參數設定完成，將護架裝置上去")
st.image("C:\\Users\\luxui\\thermal_fluid\\pages\\images\\j.png", caption=" ")
st.write("3.將黏度計放置於測量樣品中，裝上轉針")
st.image("C:\\Users\\luxui\\thermal_fluid\\pages\\images\\k.png", caption=" ")
st.write("4.設定轉針號碼與轉速並打開馬達開關鈕測量樣品黏度。帶黏度穩定後，讀取顯示幕數據並記錄，再依序對 40℃、60℃、70℃進行量測。")
st.image("C:\\Users\\luxui\\thermal_fluid\\pages\\images\\l.png", caption=" ")
st.write("(三圖)依序為 43℃、61℃、78℃")
st.write("5.查看黏度計數據")
st.image("C:\\Users\\luxui\\thermal_fluid\\pages\\images\\m.png", caption=" ")
st.image("C:\\Users\\luxui\\thermal_fluid\\pages\\images\\n.png", caption=" ")
st.image("C:\\Users\\luxui\\thermal_fluid\\pages\\images\\o.png", caption=" ")
st.image("C:\\Users\\luxui\\thermal_fluid\\pages\\images\\p.png", caption=" ")
st.write("(有上傳yt的六秒錄影)")
st.write("https://youtube.com/shorts/Yx-8dL7XaOs?feature=share")
st.write("(一)轉針號碼設定說明")
st.write("調整轉針設定轉針號碼(例:由 1 號變換至 3 號針)。")
st.image("C:\\Users\\luxui\\thermal_fluid\\pages\\images\\q.png", caption=" ")
st.write("(二)轉速設定說明")
st.write("選擇轉子換轉速組合，使扭矩百分比讀值在 10-100%範圍內。黏度大的樣品，使用面積小的轉子換較低的轉速，對於低黏度的樣品，情況相反")
st.image("C:\\Users\\luxui\\thermal_fluid\\pages\\images\\r.png", caption=" ")
# 伍、實驗結果與討論
st.header("伍、實驗結果與討論")
