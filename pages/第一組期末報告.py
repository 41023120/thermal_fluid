...
st.write("主題二、環境量測與控制裝置機械設計")
st.write("""
在此次實驗中，我們首次進行溫度測量時發現，散熱頂部的溫度竟然高於底部溫度，且與模擬數據相比，結果差異極大。經過組員討論並聽取老師的指導，我們找出了問題的根源：實驗時應該要兩個量測溫度器譯起測量，才能提供正確的數值，如果不意起測量則，無法達到預期的散熱效果。
